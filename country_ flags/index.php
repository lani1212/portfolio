...
<html>
    <head>
        ...
        <title>Change country flags and Isd code using PHP MySQL Ajax and jQuery</title>
    ...
    <body>
        <div id="container">
            <div id="body">
                <div class="mainTitle" >Change country flags and Isd code using PHP MySQL Ajax and jQuery</div>
                <article>
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width: 40%;"><div id="cname"></div></td>
                        </tr>
                    </table>
                </article>
